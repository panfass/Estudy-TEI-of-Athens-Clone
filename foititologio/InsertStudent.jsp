...
si.setName( name );
si.setSurname( surname );
si.setSemester( semester );
si.setAM( am );
String xmlInput = JavaObjectToXMLConversion.convert( si );


RESTPost.httpPost( "http://localhost:8080/foithths/rest-api/insert/", xmlInput, "xml" );
...
%>
	<h2>The insertion of the new student was successful.</h2>

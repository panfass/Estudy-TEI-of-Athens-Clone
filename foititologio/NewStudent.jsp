...
<form method="post" action="InsertStudent.jsp">
            <table>
            	<thead>
                    <tr>
                        <th colspan="2">Please provide the personal information of the student:</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td><center>Name</center></td>
                        <td><center><input type="text" name="name" value="" required /></center></td>
                    </tr>
                    <tr>
                        <td><center>Surname</center></td>
                        <td><center><input type="text" name="surname" value="" required /></center></td>
                    </tr>
                    <tr>
                        <td><center>Semester</center></td>
                        <td><center><input type="text" name="semester" value="" required /></center></td>
                    </tr>
                    <tr>
                        <td><center>AM</center></td>
                        <td><center><input type="text" name="AM" value="" required /></center></td>
                    </tr>
                    <tr>
                        <td><center>Username</center></td>
                        <td><center><input type="text" name="username" value="" required /></center></td>
                    </tr>
                    <tr>
                        <td><center>Password</center></td>
                        <td><center><input type="password" name="password" value="" required /></center></td>
                    </tr>
                   	<tr>
                        <td><center></center></td>
						 <td><input type="submit" onclick="goBack()" value="Go back" /></td>				

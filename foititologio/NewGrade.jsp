	...
	<td align="center">
		<table border="0" class="tableborderColorOnly" cellspacing="0" cellpadding="0" style="width:100%">
            ...
            <table>
            	<thead>
                    <tr>
                        <th colspan="2">Please provide the required information:</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td><center>Student AM</center></td>
                        <td><center><input type="text" name="AM" value="" required /></center></td>
                    </tr>
                    <tr>
                        <td><center>Course</center></td>
                        <td><center><input type="text" name="Mathima" value="" required /></center></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><center><input type="text" name="Grade" value="" required /></center></td>
                    </tr>
                   	<tr>
                        <td><center></center></td>

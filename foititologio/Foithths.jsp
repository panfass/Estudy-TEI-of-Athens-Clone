...
String msg = RESTPost.httpPost( "http://localhost:8080/foithths/rest-api/retrieve", xmlInput, "xml" );
System.out.println( "msg = " + msg );

List<Foithths> foithtes = XMLParser.parseFoithths( msg );
...
<TR>
<TD><center><%=foithths.getName()%></TD>
<TD><center><%=foithths.getSurname()%></TD>
<TD><center><%=foithths.getSemester()%></TD>
<TD><center><%=foithths.getAM()%></TD>
</TR>
<br>
...
<br>
<ul>
  <li><a href="Grades.jsp">Retrieve my Grades</a></li>

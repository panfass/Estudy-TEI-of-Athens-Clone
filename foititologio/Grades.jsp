...
<%@page import="dataModel.Grade"%>
<%@page import="dataModel.GradesAllFoithtes"%>
<%@page import="dataModel.Foithths"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!-- saved from url=(0041)file:///C:/Users/Takis/Desktop/index.html Testff-->
...
Object obj = session.getAttribute( "userID" ); //System.out.println( "id = " + obj );
int userID = (Integer) obj; //System.out.println( "id = " + id );

obj = session.getAttribute( "database" );
...
si.setUserID( userID );
String xmlInput = JavaObjectToXMLConversion.convert( si ); //System.out.println( "xmlInput = " + xmlInput );

String msg = RESTPost.httpPost( "http://localhost:8080/grades/rest-api/retrieve", xmlInput, "xml" );
System.out.println( "msg = " + msg );

GradesAllFoithtes gradesAllFoithtes = XMLParser.parseGrades( msg );  //ta pairnei se morfi listas apo GradesAllFoithtes
List<Foithths> foithtes = gradesAllFoithtes.getFoithtes();

for( int i = 0; i < foithtes.size(); ++i){
%>

<TABLE BORDER="3" class="customtables" >
<TR>
<TH>Name</TH>
<TH>Surname</TH>
<TH>AM</TH>
...
<%
	Foithths foithths = foithtes.get( i );
%>

<TR>
<TD><center><%=foithths.getName()%></center></TD>
<TD><center><%=foithths.getSurname()%></center></TD>
<TD><center><%=foithths.getAM()%></center></TD>
</TR>
...
<%
	List<Grade> grades = foithths.getGrades();
...
%>
		...
		<TD><center><%=g.getMathima()%> </center></TD> 
		<TD><center><%=g.getGrade()%> </center></TD>
		</TR>
	<% } %>
</TABLE>
</TD>
...
<% } %>
 ...
 <form action="index.html">
 	<input type="submit" onclick="goBack()" value="Go back" />
